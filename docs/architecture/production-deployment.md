...
nulls that ECMWF ENS is known to carry (a WARN), and its `nwp_run_is_complete`
...
weather column that carries no data at all. The reasoning behind exactly where that fatal/tolerated line
