...
| State — or check — a measurable claim about the engineering | [`docs/engineering-hypotheses.md`](engineering-hypotheses.md). Add a test with a threshold and a resolution point; never renumber an existing one |
