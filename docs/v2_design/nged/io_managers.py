...
class DeltaPolarsIOManager(dg.ConfigurableIOManager):
    ...
    def _write_incremental_append(self, context: dg.OutputContext, obj: pl.DataFrame, target_path: str) -> None:
        """
    ...
    def _write_overwrite(self, context: dg.OutputContext, obj: pl.DataFrame, target_path: str) -> None:
        """
    ...
    def load_input(self, context: dg.InputContext) -> pl.DataFrame:
        ...
        table_name = context.upstream_output.metadata.get("delta_table_name", context.asset_key.path[-1])
        ...
        if context.has_asset_partitions:
            ...
            time_col = context.upstream_output.metadata.get("delta_partition_time_col", "period_end_time")
