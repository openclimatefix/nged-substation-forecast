...
- **MVA / reverse flow**: primary data is disaggregated from metered generation where possible, but
  ...
  See also the [MVA discussion in Differentiable Physics](../techniques/differentiable-physics.md#8-apparent-power-mva-metering).
