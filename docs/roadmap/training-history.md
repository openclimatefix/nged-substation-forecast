...
- **Source it rather than hand-coding dates.** The Oxford COVID-19 Government Response Tracker
  ...
  through 2021–22. Start with stringency; escalate if the leaderboard says the feature matters.
  Both series ended in 2022, so check they are still downloadable.
