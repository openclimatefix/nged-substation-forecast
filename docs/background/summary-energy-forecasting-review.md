...
the figure does not transfer to another dataset. The warning is not to read that transfer-learning
accuracy as achievable here: Teng et al. are told each site's capacity, whereas inferring that
