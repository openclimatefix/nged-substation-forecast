...
- [NGED's network and its data](network.md) — the primary substations, bulk supply points, and
  grid supply points NGED operates, the generation connected to them, and the false zeros, stuck
...
- [NGED's incumbent forecast](nged-incumbent-forecast.md) — the historical-analogue method that,
