...
window, [from November 2024 to August 2026](../studies/past-weather/solar.md#the-four-extra-open-meteo-models).
...
product](../studies/past-weather/solar.md#met-office-weather-station-observations-as-a-stand-in-for-a-gridded-product).
...
1. **ECMWF IFS HRES 9 km on Open-Meteo** (not on the roadmap) — a 9 km forecast from the IFS model
   ...
   models](../studies/past-weather/solar.md#the-four-extra-open-meteo-models), so the
...
[its shorter row set from November 2024](../studies/past-weather/solar.md#the-four-extra-open-meteo-models).
