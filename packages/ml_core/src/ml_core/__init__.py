...
model's input, the metrics that score its output, the cross-validation and MLflow run helpers
that give a training run an identity, the reproducibility provenance stamped onto that run, and
the production helpers the live service loads and serves a promoted model through.
"""
