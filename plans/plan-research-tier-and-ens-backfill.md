...
- **Fetch the control member only,** because cross-validation trains on it today. That is about 1,020 range requests and 0.5 GB per date, so about 4–5 hours and 530 GB for 2021-03-21 to 2024-03-31 on the workstation, with no cloud machine.
