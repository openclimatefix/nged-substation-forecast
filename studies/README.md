...
| `open_meteo_ensemble_means/` | How well do Open-Meteo's ensemble-mean products for MOGREPS-UK, ICON-D2-EPS, ICON-EU-EPS, and ECMWF IFS ENS predict solar and wind power, beside CAMS and ERA5? | In progress; see `studies/open_meteo_ensemble_means/README.md` |
