...
| `wind_product_charts.py` | The same for the nine charts on [Which weather product best describes past wind?](https://openclimatefix.github.io/nged-substation-forecast/studies/past-weather/wind/), from `wind_products.py`'s report and its `--era5-by-year` table. |
