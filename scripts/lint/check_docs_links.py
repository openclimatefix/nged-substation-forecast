...
Second, `docs/api/*.md` pages hold mkdocstrings directives (`::: some.module`). Those anchors are
generated by mkdocstrings at build time, which this script cannot reproduce, so the script checks
only that the page exists and reports the anchor check as skipped.
"""
