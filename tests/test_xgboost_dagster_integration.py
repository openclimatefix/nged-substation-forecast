...
def test_xgboost_dagster_integration() -> None:
    ...
    if not has_enough_data:
        ...
        context = dg.build_asset_context(resources={"settings": settings})
        ...
        lp_ctx = dg.build_asset_context(
            partition_key=test_end_date.isoformat(), resources={"settings": settings}
        )
        ...
        for i in range(45):
            ...
            ctx = dg.build_asset_context(partition_key=date_str, resources={"settings": settings})
